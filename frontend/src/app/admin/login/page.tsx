  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center">
      <div className="w-full max-w-md rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-8">
        ...
        <p className="mt-1 text-sm text-[var(--color-text-muted)]">Sign in to manage content</p>
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded border border-[var(--color-border)] bg-[var(--color-bg)] px-3 py-2 text-white focus:border-[var(--color-accent)] focus:outline-none"
              required
            />
          </div>
          <div>
